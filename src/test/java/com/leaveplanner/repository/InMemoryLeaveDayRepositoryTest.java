...
class InMemoryLeaveDayRepositoryTest {
    ...
    void 저장하면_id가_할당된다() {         
        //given
        LeaveDay leaveDay = new LeaveDay(1L, LocalDate.of(2026, 1, 10), LeaveType.ANNUAL, "연차");
    ...
    void 사용자와_날짜로_휴가를_조회할_수_있다() {
        ...
        LeaveDay leaveDay = new LeaveDay(1L, date, LeaveType.ANNUAL, "연차");
        repository.save(leaveDay);

        // when
        Optional<LeaveDay> result = repository.findByUserIdAndDate(1L, date);
    ...
    void 사용자와_월로_휴가_목록을_조회한다() {
        //given
        LeaveDay leaveDay1 = new LeaveDay(1L, LocalDate.of(2026, 1, 10), LeaveType.ANNUAL, "연차");
        LeaveDay leaveDay2 = new LeaveDay(1L, LocalDate.of(2026, 1, 11), LeaveType.ANNUAL, "연차");
        LeaveDay leaveDay3 = new LeaveDay(1L, LocalDate.of(2026, 2, 10), LeaveType.ANNUAL, "연차");
    ...
    void 휴가를_삭제할_수_있다() {
        // given
        LeaveDay leaveDay = repository.save(
            new LeaveDay(1L, LocalDate.of(2026, 1, 10), LeaveType.ANNUAL, "연차")
        );
